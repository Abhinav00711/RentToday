...
<html lang="en" dir="ltr">
    ...
    <body id="page-top">
        ...
        <?php 
         ...
         $urls = array();
         try {
            $sql1 = "SELECT * FROM property_details;";
            $q1 = $pod->query($sql1);
        ...
        <div id="wrapper">
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="color: var(--indigo);background: #7d30bc;">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <a href="../edit_profile/edit_profile.php">
                            ...
                            <ul class="navbar-nav flex-nowrap ml-auto">
                                <li class="nav-item dropdown no-arrow mx-1">
                                    <div class="nav-item dropdown no-arrow">
                                        <a class="dropdown-toggle nav-link" href="../tenant_favorites/index.php">
                ...
                <footer class="bg-white sticky-footer">
                    <div class="container my-auto">
                        <div class="text-center my-auto copyright">
                            <span>Copyright © RentToday 2021</span>
                        </div>
                    </div>
                </footer>
            </div>
