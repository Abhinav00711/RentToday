<?php
    ...
    if(isset($_COOKIE['owner_id'])) {
        ...
        try {
            $sql = "SELECT * FROM appointment WHERE owner_id = ('$username');";
...
<html lang="en">
    <head>
        ...
        <script>
            function comp(appid){
                var myForm = document.getElementById('completedform');
                document.getElementById('hidecomp').value = appid;
                myForm.submit();
            }
            ...
            function appdet(appid){
                document.cookie = "app_id=" + appid +"; path=/;";
                location.href='../App Det/app_details.php';
            }
        </script>
    </head>
    <body>
            ...
            <div class="container"><span></span>
                ...
                <div class="container-fluid" id="navcol-1">
                    <ul class="navbar-nav flex-nowrap ml-auto">
                        <li class="nav-item">
                            <div class="nav-item">
                                <a style="margin-top: 5px;" class="nav-link" href="../Owner Dashboard/owner_dashboard.php">
                        ...
                        <li class="nav-item">
                            <div class="nav-item">
                                <a class="nav-link">
                                <form method="post" action="../Owner Dashboard/logout.php">
        ...
        <br><br><br><br><br>
        <form method="post" action="comp.php" id="completedform" name="completedform">
            <input type="hidden" id="hidecomp" name="hidecomp"/>
        </form>
        <form method="post" action="cancel.php" id="cancelform" name="cancelform">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="pending" role="tabpanel" aria-labelledby="pa-tab">
                        <table>
                            ...
                            ?>
                            <tr class="t1">
                                <td class="tname" onclick="appdet('<?php echo $app[$i]['app_id']?>');"><?php echo $app[$i]['tenant_id']?></td>
                                <td class="date" onclick="appdet('<?php echo $app[$i]['app_id']?>');"><?php echo $app[$i]['app_date']?></td>
                                <td class="time" onclick="appdet('<?php echo $app[$i]['app_id']?>');"><?php echo $app[$i]['app_time']?></td>
                                <td class="icons">
                                    <img src="assets/img/yes.png" onclick="comp(<?php echo $app[$i]['app_id']?>);">
                                </td>
                                <td>
                    ...
                    <div class="tab-pane fade" id="completed" role="tabpanel" aria-labelledby="ca-tab">
                        <table>
                            ...
                            ?>
                            <tr class="t2">
                                <td class="tname"><?php echo $app[$i]['tenant_id']?></td>
